    ...
    public void OnStartStoryButton()
    {
        switch(_currentSelectedIndex)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                Metadata.Instance.startingPrompt = "I love to stay at grandma's house. She always";
                Metadata.Instance.currentPrompt = "I love to stay at grandma's house. She always";
                break;
            case 3:
